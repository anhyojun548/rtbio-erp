              ...
              {rows.map((r, i) => (
                <tr key={r.salesRepId} className="hover:bg-slate-50">
                  <td className="px-4 py-2">
                    <span className="w-4 inline-block text-slate-400 tabular-nums text-xs mr-2">
                      {i + 1}.
                    </span>
                    <Link
                  ...
                  <td className="px-4 py-2">
                    <span className="inline-block rounded bg-slate-100 text-slate-600 text-[10px] px-1.5 py-0.5">
