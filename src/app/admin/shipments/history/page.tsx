/**
 * 출고내역 (Phase 3D-4b, R17).
 *
 * completedAt != null 인 Shipment 리스트.
 * 필터: 기간(from/to), 거래처, 텍스트 검색(주문번호/거래처명/코드).
 * CSV 다운로드 버튼은 `/admin/shipments/history/csv` 로 동일 쿼리 전달.
 */
