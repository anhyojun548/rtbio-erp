...
const PRESETS = [
  ...
  // 2026-05-12 미팅 신규 위젯
  { name: '베트남 발주 입고 현황', type: 'table', preset: 'procurement_status', desc: '월별 발주 → 항공/선박 입고 트래킹 (대표님 핵심 요청)', w: 8, h: 5 },
  { name: '생산발주 진행률', type: 'gauge', preset: 'production_progress', desc: '이번달 베트남 발주 입고율', w: 3, h: 3 },
  { name: '운송중 선적 알림', type: 'table', preset: 'in_transit_shipments', desc: '항공/선박 운송중 + 예상 입항일', w: 6, h: 4 },
  { name: '원부자재 발주 비율', type: 'donut', preset: 'material_split', desc: '원단/부자재/제품 발주 비율 (대표님 요청)', w: 4, h: 4 },
  { name: 'UDI 보고 현황', type: 'kpi', preset: 'udi_status', desc: '월별 UDI 공급내역 보고 현황', w: 3, h: 2 },
  { name: '미확인 알림', type: 'kpi', preset: 'unread_notifications', desc: '미확인 알림 개수', w: 3, h: 2 },
];
