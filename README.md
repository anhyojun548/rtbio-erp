...
**현재 단계**: 🟢 Phase 1 · 2 완료 (2026-04-18) — 스키마·인증·RBAC. 다음: Phase 3 CRUD
...
| Phase | 기간 | 내용 |
|-------|------|------|
| **P1 스키마** ✅ | W1-2 | Prisma 스키마, 멀티테넌시, 복수 배송지, 마이그레이션 |
| **P2 인증** ✅ | W3 | NextAuth, RBAC 매트릭스, 미들웨어 체인, AuditLog util |
| **P3 마스터** ⏳ | W4-5 | 제품/거래처/재고 CRUD, 할인율, 배송지 UI |
